...
// UnicornStudio Component based on Framer implementation
const UnicornStudio = () => {
  ...
  useEffect(() => {
    const initializeScript = (callback) => {
      const existingScript = document.querySelector('script[src^="https://cdn.jsdelivr.net/gh/hiunicornstudio"]');
      if (!existingScript) {
    ...
    const initializeUnicornStudio = () => {
      const projectId = "mE6lt3KNCy88vf0BNuSs";
      const query = projectId.split("?");
      const projectIdClean = query[0];
      const production = query[1] && query[1].includes("production");
      const cacheBuster = "?update=" + Math.random();
      
      elementRef.current.setAttribute("data-us-project", projectIdClean + cacheBuster);
      if (production) {
        elementRef.current.setAttribute("data-us-production", 1);
      }

      if ((window as any).UnicornStudio) {
        const existingScene = (window as any).UnicornStudio.scenes?.find(scene => 
        ...
        (window as any).UnicornStudio.init().then(scenes => {
          const ourScene = scenes.find(scene => 
            scene.element === elementRef.current || scene.element.contains(elementRef.current)
          );
          if (ourScene) {
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <a href="#pricing" className="text-gray-300 hover:text-cyan-300 transition-colors duration-200">
                Pricing
              </a>
              <div className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-emerald-600 rounded-lg hover:from-cyan-700 hover:to-emerald-700 transition-all duration-200 transform hover:scale-105">
                <SignInButton />
              </div>
            </div>
          </div>
      ...
      {/* Unicorn Studio Full Screen Section */}
      <section className="relative h-screen overflow-hidden">
       ...
       <section className="relative py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
         ...
         <div className="absolute inset-0 opacity-20">
           ...
           <div className="absolute top-1/3 right-1/4 w-72 h-72 bg-emerald-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
           <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-sky-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-4000"></div>
         </div>

         <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center animate-fade-in-up">
             <h2 className="text-5xl md:text-7xl font-extrabold mb-6 bg-gradient-to-r from-cyan-400 via-emerald-400 to-sky-400 bg-clip-text text-transparent">
               Your AI-Powered
               <br />
               Code Companion
             </h2>
             ...
             <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-500">
               <div className="px-8 py-4 bg-gradient-to-r from-cyan-600 to-emerald-600 rounded-lg hover:from-cyan-700 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 shadow-2xl">
                 <SignInButton />
               </div>
               <button className="px-8 py-4 border-2 border-gray-600 text-gray-300 rounded-lg hover:border-cyan-500 hover:text-cyan-400 transition-all duration-300 transform hover:scale-105">
                 Watch Demo
               </button>
             </div>
      ...
      <section id="features" className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           >
             <h3 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">
               Powerful Features
             </h3>
          ...
          <div className="grid gap-8 grid-cols-1 md:grid-cols-3">
            {features.map((feature, index) => (
              <div
                ...
                id={`feature-${index}`}
                data-animate
                                 className={`group relative bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-500 transform hover:scale-105 ${
                ...
                <div className="relative z-10">
                  <div className={`inline-flex p-3 rounded-xl bg-gradient-to-r ${feature.gradient} bg-opacity-20`}>
                    {feature.icon}
                                     ...
                                     <h4 className="mt-6 text-xl font-semibold text-white group-hover:text-cyan-300 transition-colors duration-300">
                     {feature.title}
                   </h4>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 grid-cols-1 md:grid-cols-2">
            ...
            >
              <div className="text-center">
                <h4 className="text-2xl font-bold text-white">Free</h4>
                                 <div className="mt-4 text-4xl font-bold text-cyan-400">$0</div>
                ...
                <ul className="mt-6 space-y-3 text-left">
                  ...
                  <li className="flex items-center text-gray-300">
                    ...
                    Community support
                                 ...
                                 <button className="mt-8 w-full px-6 py-3 border-2 border-cyan-600 text-cyan-400 rounded-lg hover:bg-cyan-600 hover:text-white transition-all duration-300">
                   Get Started
                 </button>
              </div>
            </div>
            ...
            {/* Pro Plan */}
               ...
               id="pro-plan"
               data-animate
               className={`bg-gradient-to-r from-cyan-600 to-emerald-600 p-8 rounded-2xl shadow-2xl border border-cyan-500/50 transform scale-105 transition-all duration-1000 ${
                ...
                <ul className="mt-6 space-y-3 text-left">
                  ...
                  <li className="flex items-center text-indigo-100">
                    ...
                    Advanced analytics
                                 ...
                                 <button className="mt-8 w-full px-6 py-3 bg-white text-cyan-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
                   Start Free Trial
                 </button>
              </div>
            </div>
       ...
       <section className="py-20 bg-gradient-to-r from-cyan-600 to-emerald-600">
         <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
           ...
           <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
             <div className="px-8 py-4 bg-white text-cyan-600 rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-2xl">
               <SignInButton />
             </div>
             <button className="px-8 py-4 border-2 border-white text-white rounded-lg hover:bg-white hover:text-cyan-600 transition-all duration-300 transform hover:scale-105">
               Schedule Demo
             </button>
           </div>
         </div>
